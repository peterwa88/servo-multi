...
fn servo_tab_widget_text_exact<S: Into<String>>(s: S) -> egui::WidgetText {
    egui::WidgetText::RichText(servo_tab_label_text_exact(s).into())
}
...
fn servo_install_tab_fonts_exact(ctx: &egui::Context) {
    ...
    let candidates = [
        std::path::PathBuf::from(r"D:\workspace\claude\servo-multi\servo_src\09_NotoSerifCJKsc\OTF\SimplifiedChinese\NotoSerifCJKsc-Regular.otf"),
        std::path::PathBuf::from("09_NotoSerifCJKsc/OTF/SimplifiedChinese/NotoSerifCJKsc-Regular.otf"),
        std::path::PathBuf::from("../09_NotoSerifCJKsc/OTF/SimplifiedChinese/NotoSerifCJKsc-Regular.otf"),
